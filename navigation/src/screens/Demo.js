...
class Demo extends Component {
  constructor(props) {
    ...
    this.onClickWebViewHandler = this.onClickWebViewHandler.bind(this);
  }

  render() {
    return (
      <ScrollView style={{flex: 1, height: 1800}}>
      <Text style={styles.h1}>React Native Navigation Demo!</Text>
      ...
      <Button title='Test WebView' testID={testIDs.WEB_VIEW_BUTTON}  onPress={this.onClickWebViewHandler} />
  ...
  onClickWebViewHandler() {
    Navigation.push(this.props.componentId, {
      component: {
        name: 'navigation.playground.WebView',
        options: {
          animated: true,
          animationType: 'fade' // 'slide-down'
        }
      }
    });
  }
